...
file_name = "03_dqn_test"  # the name of the game being played for log files
...
class DQNagent():
    ...
    def train_model(self):
        ...
        states      = np.zeros((self.batch_size, rows+1, cols, 1))
        next_states = np.zeros((self.batch_size, rows+1, cols, 1))

...
game_name = "05_duelingdqn_b"  # the name of the game being played for log files
...
class DQN_agent:
    ...
    def train_model(self):
        ...
        states = states.reshape(self.batch_size, rows+1, cols, 1)
        next_states = next_states.reshape(self.batch_size, rows+1, cols, 1)
